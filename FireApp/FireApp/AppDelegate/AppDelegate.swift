...
////        if UIApplication.sharedApplication().applicationState == UIApplication.State.inactive {
//
//            let localNotification = UILocalNotification();
//            localNotification.alertBody = "zain ali \(payload.dictionaryPayload)"
//            localNotification.applicationIconBadgeNumber = 1;
//            localNotification.soundName = UILocalNotificationDefaultSoundName;
//
//            UIApplication.shared.presentLocalNotificationNow(localNotification);
////        DispatchQueue.main.async {
////            let alert = UIAlertView(title: "VoIP Notification", message: "Zain Ali", delegate: nil, cancelButtonTitle: "OK");
////            alert.show()
////        }
//
